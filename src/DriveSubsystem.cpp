...
DriveSubsystem::DriveSubsystem() : driveTurnkP("Drive Turn P Value", .05),
								   ...
								   m_leftMaster = new WPI_TalonSRX(LEFT_FRONT_PORT),
								   m_rightMaster = new WPI_TalonSRX(RIGHT_FRONT_PORT),
								   m_leftSlave = new WPI_TalonSRX(LEFT_BACK_PORT),
								   m_rightSlave = new WPI_TalonSRX(RIGHT_BACK_PORT),
